...
from the tickers that were present in the stocks dataset. We also used an
implementation of the Porter Stemmer algorithm ~\cite{porter} to improve search results. \\ \\
