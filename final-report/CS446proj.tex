...
\includegraphics[width=14cm]{images/unweighted/ex.0.png}

  Graph2 \\
  
\includegraphics[width=14cm]{images/unweighted/ex.1.png}

  Graph3 \\
  
\includegraphics[width=14cm]{images/unweighted/ex.2.png}

  Graph4 \\
  
\includegraphics[width=14cm]{images/unweighted/ex.3.png}
  
\item Experiment 2: TO DO
  
  Graph1 \\
  
\includegraphics[width=14cm]{images/weighted/ex.0.png}

  Graph2 \\
  
\includegraphics[width=14cm]{images/weighted/ex.1.png}

  Graph3 \\
  
\includegraphics[width=14cm]{images/weighted/ex.2.png}

  Graph4 \\
  
\includegraphics[width=14cm]{images/weighted/ex.3.png}
