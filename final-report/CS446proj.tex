...
We propose a model that will predict the stock price movement as the expectation
...
\begin{itemize}
	...
	\item A probabilistic model with a calculated distribution using the similarity
    between documents as a probability measure. This will require both the
